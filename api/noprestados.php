...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    if (isset($_GET['id_estudiante'])) {
        // Mostrar lista de préstamos para un estudiante específico con nombres de libros y prestado = 0
        ...
        WHERE prestamos.Estudiantes_id = :estudianteId AND prestamos.prestado = 0");
